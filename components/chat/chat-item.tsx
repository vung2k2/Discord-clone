...
import type { Member, Profile } from '@/generated/prisma/client';
...
const roleIconMap: Record<MemberRoleType, React.ReactElement | null> = {
  GUEST: null,
        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2">
            <div className="flex items-center">
              ...
              {roleIcon && <ActionTooltip label={member.role}>{roleIcon}</ActionTooltip>}
            </div>
