...
const roleIconMap = {
  ...
  ADMIN: <ShieldAlert className="w-4 h-4 ml-2 text-red-400" />,
};
...
const MemberModal = () => {
  ...
  const server = data.server as ServerWithMemberAndProfile | undefined;
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white dark:bg-[#1e1f22] text-black dark:text-white overflow-hidden">
        ...
        <ScrollArea className="mt-4 max-h-105 pr-6">
              ...
              <div key={member.id} className="flex items-center gap-x-2 mb-6">
                ...
                {server.profileId !== member.profileId && loadingId !== member.id && (
                  <div className="ml-auto">
                    <DropdownMenu>
                      <DropdownMenuTrigger>
                        <MoreVertical className="w-4 h-4 text-zinc-200 hover:cursor-pointer" />
                      </DropdownMenuTrigger>
